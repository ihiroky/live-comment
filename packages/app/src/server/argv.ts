...
import { parseLogLevel, LogLevel } from '@/common/Logger'
...
export function parseArgv(): Argv {
  const argv = yargs(hideBin(process.argv))
    ...
    .help()
  return {
    configPath: findConfigPath(argv.argv.configPath),
    port: parsePort(argv.argv.port),
    loglevel: parseLogLevel(argv.argv.loglevel)
  }
}
